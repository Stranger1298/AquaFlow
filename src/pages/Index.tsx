...
export default function Index() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-water-800 to-water-600 text-white">
        <div className="relative px-6 lg:px-8">
            ...
            <div className="text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                ...
                <Button 
                  ...
                  className="border-white text-green-300 hover:text-green-100 hover:bg-white/10"
          ...
          {/* Water wave effect */}
          <div className="absolute bottom-0 left-0 right-0 h-16 bg-water-200" style={{ 
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link to="/products" className="text-water-600 hover:underline">
              View all products
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-water-100 flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-water-600">
              ...
              <p className="text-gray-600">Explore a wide range of water products from trusted vendors in your area.</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">Add products to your cart and choose to waive the delivery fee by watching an ad.</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">Your water products will be delivered quickly and safely to your doorstep.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="py-12 px-4 bg-water-50">
